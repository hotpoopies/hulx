...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    private int selectedFiltersIndex;
    ...
    public int getSelectedFiltersIndex() {
        return selectedFiltersIndex;
    }

    public void setSelectedFiltersIndex(int selectedFiltersIndex) {
        this.selectedFiltersIndex = selectedFiltersIndex;
    }
}
